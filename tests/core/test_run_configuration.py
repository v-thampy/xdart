...
def test_nonaverage_paths_have_zero_average_reachability_and_allocations(tmp_path, monkeypatch):
    ...
    from tests.xdart.scattering.test_e3_join_oracle import _mount, _run, _wait
    ...
    target = tmp_path / "ordinary.nxs"; _write_tiff(raw, 1); write_poni(poni)
