...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.integratorFrame.setMaximumSize(QSize(16777215, 360))
        ...
        # BOTTOM.  staticWidget installs the shared RunControlsBar into
        ...
        # the RunControlsBar' snug content height, so the bottom controls box
