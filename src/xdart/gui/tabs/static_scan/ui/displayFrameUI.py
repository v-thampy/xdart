...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.slice_center.setMinimumSize(QSize(60, 0))
        self.slice_center.setMaximumSize(QSize(60, 16777215))
        ...
        self.slice_width.setMinimumSize(QSize(60, 0))
        self.slice_width.setMaximumSize(QSize(60, 16777215))
    ...
    def retranslateUi(self, Form):
        ...
        self.slice.setText(QCoreApplication.translate("Form", u"χ (c/w)", None))
#if QT_CONFIG(tooltip)
        self.slice.setToolTip(QCoreApplication.translate("Form", u"integration window over χ (the other 2D axis): center / width", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.slice_center.setToolTip(QCoreApplication.translate("Form", u"slice center", None))
#endif // QT_CONFIG(tooltip)
