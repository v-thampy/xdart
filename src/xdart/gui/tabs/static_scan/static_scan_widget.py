...
class staticWidget(QWidget):
    ...
    def set_wrangler(self, qint):
        ...
        # The display-clearing cascade (axes rebuild + bkg clear + cache wipe) is
        # DEFERRED on a manual browser .nxs select in Int 1D/2D so the plots stay
        # as-is until a frame is clicked; runs immediately for the run path + viewers.
