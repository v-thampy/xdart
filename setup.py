...
setup(
    ...
    description='A pyFAI based GUI utility to rebin and visualize X-ray Diffraction data',  # Optional
    ...
    # project.
    author='Vivek Thampy',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='vthampy@slac.stanford.edu',  # Optional
    ...
    classifiers=[  # Optional
        ...
        # 'Intended Audience :: X-Ray Scattering Community',
    ...
    # larger catalog.
    keywords='xrd, diffracion, pyFAI',  # Optional
