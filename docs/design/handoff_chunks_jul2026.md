...
| BW-A4 | Blocker wave S-8/S-11/S-12/S-9/S-10 sweep | M | med | parsed series first-frame filter, fail-loud zero-discovery summary, live Overall aggregates use the writer scan tail and invalidate only on flush signature, GUI store consumes the frame-precise heavy window, and all five late writer sites lock before pausing the H5 pool | BW-A3 | fixed-unverified (this commit); gates: append skip, MEM-2 wiring, pause/resume lock order, aggregation wiring, scan aggregate, full GI spine |
